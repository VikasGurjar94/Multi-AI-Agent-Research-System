...
/* ── Streamlit text input overrides (FIXED: was malformed, broke text visibility) ── */
...
/* ── Make native st.markdown content (final report / critic feedback) readable ── */
.report-panel .stMarkdown, .feedback-panel .stMarkdown {
    color: #e8e4dc !important;
}
.report-panel .stMarkdown h1, .report-panel .stMarkdown h2, .report-panel .stMarkdown h3,
.report-panel .stMarkdown h4, .report-panel .stMarkdown h5, .report-panel .stMarkdown h6,
.feedback-panel .stMarkdown h1, .feedback-panel .stMarkdown h2, .feedback-panel .stMarkdown h3,
.feedback-panel .stMarkdown h4, .feedback-panel .stMarkdown h5, .feedback-panel .stMarkdown h6 {
    font-family: 'Syne', sans-serif !important;
    color: #f5f1e8 !important;
}
.report-panel .stMarkdown p, .report-panel .stMarkdown li, .report-panel .stMarkdown span,
.feedback-panel .stMarkdown p, .feedback-panel .stMarkdown li, .feedback-panel .stMarkdown span {
    color: #cdc8bf !important;
    line-height: 1.8 !important;
    font-family: 'DM Sans', sans-serif !important;
}
.report-panel .stMarkdown strong, .feedback-panel .stMarkdown strong {
    color: #ff8c32 !important;
}
.report-panel .stMarkdown a, .feedback-panel .stMarkdown a {
    color: #ff8c32 !important;
}
.report-panel .stMarkdown code, .feedback-panel .stMarkdown code {
